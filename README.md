...
- A **HAIR GRID** button appears at the top center of the appearance screen. It works in New Game and in edit mode (mirror/ripperdoc).
- The grid shows 32 styles per page (4×8). Each tile shows its index, the display name and the internal option name, so CCXL hairs that share a display name can be told apart.
...
2. New Game → appearance step: the **HAIR GRID** button is visible at the top center.
